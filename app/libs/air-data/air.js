	...
	return (function() {
		...
		function n() {
			...
			return t &&
				n.classList.add(
					...t.split(' ')
				), s && (n.id = s), i && (n.innerHTML = i), a && r(n, a), n
		}
		function r(e, t) {
			...
			return e instanceof Date ||
				(
					'string' == typeof e &&
						...
						(e += 'T00:00:00'),
					(t = new Date(e))
				), isNaN(t.getTime()) && (console.log(`Unable to convert value "${e}" to Date object`), (t = !1)), t
		}
		function $(e) {
			let t = '\\s|\\.|-|/|\\\\|,|\\$|\\!|\\?|:|;'
		...
		class C {
			constructor() {
				...
				k(this, 'focus', () => {
					...
					t ? this.focus() : !t && this.focused && this.removeFocus(), this.opts
			...
			_createElement() {
				var e
				let { year: t, month: i, fullMonth: s, date: a, fullDate: r } = o(
						this.date
					),
					h =
			...
			_handleClasses() {
				this.$cell.setAttribute(
					'class',
					''
				), this._handleInitialFocusStatus(), this.dp.hasSelectedDates && (this._handleSelectedStatus(), this.dp.opts.range && this._handleRangeStatus()), this.$cell.classList.add(...this._getClassName())
			}
			get isDisabled() {
		...
		class T {
			constructor(e) {
				...
				_(this, 'handleClick', e => {
					...
					let { onClickDayName: t } = this.opts,
						i = e.target
					i.closest(S) && this.handleClick(e), t &&
					...
					let t = y(e.target, S),
						i = t && t.adpCell
					p(i.date, this.dp.rangeDateFrom) && (this.rangeFromFocused = !0), p(
						i.date,
						this.dp.rangeDateTo
					...
					if (2 === s.length) {
						if (this.rangeFromFocused && !m(r, a)) {
							...
							r.setHours(e), r.setMinutes(
								t
							), (this.dp.rangeDateFrom = r), this.dp.replaceDate(n, r)
						}
						if (this.rangeToFocused && !v(r, n)) {
							let { hours: e, minutes: t } = o(a)
							r.setHours(e), r.setMinutes(
								t
							), (this.dp.rangeDateTo = r), this.dp.replaceDate(a, r)
						}
					}
				}), _(this, 'onMouseUp', () => {
			...
			_bindEvents() {
				...
				D(
					this.$el,
					'mouseover',
					this.onMouseOverCell
				), D(this.$el, 'mouseout', this.onMouseOutCell), D(this.$el, 'click', this.onClickBody), e && t && (D(this.$el, 'mousedown', this.onMouseDown), D(this.$el, 'mousemove', this.onMouseMove), D(window.document, 'mouseup', this.onMouseUp))
			}
			_bindDatepickerEvents() {
				this.dp.on(
					i.eventChangeViewDate,
			...
			_getDayNamesHtml() {
				...
				for (; r < 7; ) {
					...
					;(t += `<div class="${u('air-datepicker-body--day-name', {
						...
						'-clickable-': !!a
					})}" data-day-index='${e}'>${this.dp.locale.daysMin[
						e
					]}</div>`), r++, n++
				}
				return t
		...
		class V {
			...
			_defineDOM() {
				;(this.$title = a(
					...
					this.$el
				)), (this.$prev = a('[data-action="prev"]', this.$el)), (this.$next = a('[data-action="next"]', this.$el))
			}
			_bindEvents() {
			...
			_bindDatepickerEvents() {
				this.dp.on(
					i.eventChangeViewDate,
					this.onChangeViewDate
				), this.dp.on(i.eventChangeCurrentView, this.onChangeCurrentView), this.isNavIsFunction && (this.dp.on(i.eventChangeSelectedDate, this.renderDelay), this.dp.opts.timepicker && this.dp.on(i.eventChangeTime, this.render))
			}
			destroy() {
				this.dp.off(
					i.eventChangeViewDate,
					this.onChangeViewDate
				), this.dp.off(i.eventChangeCurrentView, this.onChangeCurrentView), this.isNavIsFunction && (this.dp.off(i.eventChangeSelectedDate, this.renderDelay), this.dp.opts.timepicker && this.dp.off(i.eventChangeTime, this.render))
			}
			_createElement() {
		...
		class H {
			...
			generateButtons() {
				...
				Array.isArray(e) || (e = [e]), e.forEach(e => {
					...
					t.onClick &&
						this.attachEventToButton(i, t.onClick), this.$el.appendChild(i)
				})
			}
			...
			createButton(e) {
				...
				return n({
					tagName: s,
					innerHtml: `<span tabindex='-1'>${'function' == typeof t
						? t(this.dp)
						: t}</span>`,
		...
		class L {
			constructor() {
				...
				E(this, 'toggleTimepickerIsActive', e => {
					...
					;(this[t.getAttribute('name')] =
						t.value), this.updateText(), this.dp.trigger(i.eventChangeTime, {
						hours: this.hours,
				...
				s &&
					(s.match($('h')) || s.match($('hh'))) &&
					(this.ampm = !0), this.init()
			}
			init() {
				this.setTime(
					this.dp.lastSelectedDate || this.dp.viewDate
				), this.createElement(), this.buildHtml(), this.defineDOM(), this.render(), this.bindDatepickerEvents(), this.bindDOMEvents()
			}
			...
			bindDOMEvents() {
				...
				navigator.userAgent.match(/trident/gi) &&
					(e =
						'change'), D(this.$ranges, e, this.onChangeInputRange), D(this.$ranges, 'mouseenter', this.onMouseEnterLeave), D(this.$ranges, 'mouseleave', this.onMouseEnterLeave), D(this.$ranges, 'focus', this.onFocus), D(this.$ranges, 'mousedown', this.onFocus), D(this.$ranges, 'blur', this.onBlur)
			}
			createElement() {
				this.$el = n({
			...
			destroy() {
				this.dp.off(
					i.eventChangeSelectedDate,
					this.onChangeSelectedDate
				), this.dp.off(i.eventChangeLastSelectedDate, this.onChangeLastSelectedDate), this.$el.parentNode.removeChild(this.$el)
			}
			buildHtml() {
				let {
					ampm: e,
			...
			defineDOM() {
				...
				;(this.$ranges = this.$el.querySelectorAll(
					'[type="range"]'
				)), (this.$hours = e('[name="hours"]')), (this.$minutes = e('[name="minutes"]')), (this.$hoursText = e('.air-datepicker-time--current-hours')), (this.$minutesText = e('.air-datepicker-time--current-minutes')), (this.$ampm = e('.air-datepicker-time--current-ampm'))
			}
			setTime(e) {
			...
			setMinMaxTime(e) {
				if ((this.setMinMaxTimeFromOptions(), e)) {
					...
					t && p(e, t) && this.setMinTimeFromMinDate(t), i &&
						p(e, i) &&
						this.setMaxTimeFromMaxDate(i)
				}
			}
			setCurrentTime(e) {
			...
			setMinMaxTimeFromOptions() {
				...
				;(this.minHours = f(
					...
					0,
					23
				)), (this.minMinutes = f(t, 0, 59)), (this.maxHours = f(i, 0, 23)), (this.maxMinutes = f(s, 0, 59))
			}
			...
			updateText() {
				;(this.$hoursText.innerHTML = d(
					this.displayHours
				)), (this.$minutesText.innerHTML = d(this.minutes)), this.ampm && (this.$ampm.innerHTML = this.dayPeriod)
			}
			set hours(e) {
				this._hours = e
		...
		class O {
			constructor(e) {
				...
				A(
					...
					'pressedKeys',
					new Set()
				), A(this, 'hotKeys', new Map([[[['Control', 'ArrowRight'], ['Control', 'ArrowUp']], e => e.month++], [[['Control', 'ArrowLeft'], ['Control', 'ArrowDown']], e => e.month--], [[['Shift', 'ArrowRight'], ['Shift', 'ArrowUp']], e => e.year++], [[['Shift', 'ArrowLeft'], ['Shift', 'ArrowDown']], e => e.year--], [[['Alt', 'ArrowRight'], ['Alt', 'ArrowUp']], e => (e.year += 10)], [[['Alt', 'ArrowLeft'], ['Alt', 'ArrowDown']], e => (e.year -= 10)], [['Control', 'Shift', 'ArrowUp'], (e, t) => t.up()]])), A(this, 'handleHotKey', e => {
			...
			destroy() {
				...
				e.removeEventListener(
					'keydown',
					this.onKeyDown
				), e.removeEventListener('keyup', this.onKeyUp), (this.hotKeys = null), (this.pressedKeys = null)
			}
			getInitialFocusDate() {
				let {
						focusDate: e,
		...
		class R {
			...
			constructor(e, t) {
				...
				if (
					(
						...
						I(this, '_finishHide', () => {
							;(this.hideAnimation = !1), this._destroyComponents(), this.$container.removeChild(
								this.$datepicker
							)
						}),
						I(this, 'setPosition', function(e) {
							...
							if (a) r.$datepicker.style.cssText = 'left: 50%; top: 50%'
								...
								r.$datepicker.style.cssText = `left: ${s + p}px; top: ${i +
									u}px`
							}
						}),
						I(this, '_setInputValue', () => {
							...
							a &&
								...
								(t.value = this._getInputValue(
									s
								)), (this.$el.value = this._getInputValue(
								i
						...
						I(this, '_updateLastSelectedDate', e => {
							;(this.lastSelectedDate = e), this.trigger(
						...
						I(this, 'destroy', () => {
							...
							i &&
								i.removeChild(this.$datepicker), this.$el.removeEventListener(
								e,
								this._onFocus
							), this.$el.removeEventListener(
								'blur',
								this._onBlur
							), window.removeEventListener('resize', this._onResize), t &&
								this._removeMobileAttributes(), this.keyboardNav &&
								this.keyboardNav.destroy(), (this.views = null), (this.nav = null), (this.$datepicker = null), (this.opts = {}), (this.$customContainer = null), (this.viewDate = null), (this.focusDate = null), (this.selectedDates = []), (this.rangeDateFrom = null), (this.rangeDateTo = null), (this.isDestroyed = !0)
						}),
						...
						I(this, '_onChangeSelectedDate', e => {
							let { silent: t } = e
							setTimeout(() => {
								this._setInputValue(), this.opts.onSelect &&
									!t &&
						...
						I(this, '_onChangeFocusedDate', function(e) {
							...
							t &&
								(i =
									...
									r.isOtherDecade(
										e
									)), i && r.setViewDate(e), r.opts.onFocus && r.opts.onFocus({ datepicker: r, date: e })
						}),
			...
			init() {
				...
				;(!B || (B && P && !o.contains(P))) &&
					...
					R.buildGlobalContainer(
						R.defaultGlobalContainerId
					), !s || j || t || this._createMobileOverlay(), this._handleLocale(), this._bindSubEvents(), this._createMinMaxDates(), this._limitViewDateByMaxMinDates(), this.elIsInput && (i || this._bindEvents(), r && !h && (this.keyboardNav = new O({ dp: this, opts: e }))), n && this.selectDate(n, { silent: !0 }), this.opts.visible && !t && this.show(), s && !t && this.$el.setAttribute('readonly', !0), t && this._createComponents()
			}
			...
			_addMobileAttributes() {
				...
				), this.$datepicker.classList.add('-is-mobile-'), this.$el.setAttribute('readonly', !0)
			}
			_removeMobileAttributes() {
				j.removeEventListener(
					'click',
					this._onClickOverlay
				), this.$datepicker.classList.remove('-is-mobile-'), this.initialReadonly || '' === this.initialReadonly || this.$el.removeAttribute('readonly')
			}
			_createMinMaxDates() {
			...
			_addTimepicker() {
				...
				})), this.$datepicker.appendChild(this.$timepicker), (this.timepicker = new L({ dp: this, opts: this.opts })), this.$timepicker.appendChild(this.timepicker.$el)
			}
			_addButtons() {
				;(this.$buttons = n({
					className: 'air-datepicker--buttons'
				})), this.$datepicker.appendChild(this.$buttons), (this.buttons = new H({ dp: this, opts: this.opts })), this.$buttons.appendChild(this.buttons.$el)
			}
			_bindSubEvents() {
				this.on(
					i.eventChangeSelectedDate,
					this._onChangeSelectedDate
				), this.on(i.eventChangeFocusDate, this._onChangeFocusedDate), this.on(i.eventChangeTime, this._onChangeTime)
			}
			_buildBaseHtml() {
				...
				this.elIsInput
					...
					: this.$el.appendChild(
							this.$datepicker
						), (this.$datepicker.innerHTML = '<i class="air-datepicker--pointer"></i><div class="air-datepicker--navigation"></div><div class="air-datepicker--content"></div>'), (this.$content = a('.air-datepicker--content', this.$datepicker)), (this.$pointer = a('.air-datepicker--pointer', this.$datepicker)), (this.$nav = a('.air-datepicker--navigation', this.$datepicker))
			}
			_handleLocale() {
				let {
					locale: e,
				...
				)), t && (this.locale.dateFormat = t), void 0 !== n && '' !== n && (this.locale.timeFormat = n)
			...
			_bindEvents() {
				this.$el.addEventListener(
					this.opts.showEvent,
					this._onFocus
				), this.$el.addEventListener('blur', this._onBlur), this.$datepicker.addEventListener('mousedown', this._onMouseDown), this.$datepicker.addEventListener('mouseup', this._onMouseUp), window.addEventListener('resize', this._onResize)
			}
			...
			selectDate(e) {
				...
				if ((e = b(e)) instanceof Date) {
					...
					if (
						...
						switch (g) {
							case 1:
								r.push(e), this.rangeDateTo || (this.rangeDateTo = e), m(
									this.rangeDateFrom,
									this.rangeDateTo
								) &&
									(
					...
					return this.trigger(i.eventChangeSelectedDate, {
						...
						date: e,
						updateTime: h
					}), this._updateLastSelectedDate(e), p &&
			...
			unselectDate(e) {
				...
				if ((e = b(e)) instanceof Date)
					return t.some((a, n) => {
						if (p(a, e))
							return t.splice(n, 1), s.selectedDates.length
								? (
										(s.rangeDateTo = ''),
										(s.rangeDateFrom = t[0]),
			...
			clear() {
				let e =
					arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
				return (this.selectedDates = []), (this.rangeDateFrom = !1), (this.rangeDateTo = !1), (this.lastSelectedDate = !1), this.trigger(i.eventChangeSelectedDate, { action: i.actionUnselectDate, silent: e.silent }), new Promise(e => {
					setTimeout(e)
				})
			}
			show() {
			...
			hide() {
				...
				;(this.visible = !1), (this.hideAnimation = !0), this.$datepicker.classList.remove('-active-'), this.customHide && this.customHide(), this.elIsInput && this.$el.blur(), this._scheduleCallAfterTransition(
					t => {
						!this.customHide &&
							((t && i) || (!t && !i)) &&
							this._finishHide(), e && e(t)
					}
			...
			_triggerOnSelect() {
				...
				i.length &&
					(
						(e = i.map(g)),
						(t = o
							? n ? s.dateFormat(e) : e.map(e => s.dateFormat(e))
			...
			_handleUpDownActions(e, t) {
				...
				i > 2 &&
					(i = 2), i < 0 && (i = 0), this.setViewDate(new Date(e.getFullYear(), e.getMonth(), 1)), this.setCurrentView(this.viewIndexes[i])
			}
			getCell(e) {
				let t =
		...
		return I(
			...
			'defaults',
			s
		), I(R, 'version', '3.6.0'), I(R, 'defaultGlobalContainerId', 'air-datepicker-global-container'), (K = R.prototype), Object.assign(K, N), t.default
	})()
})
